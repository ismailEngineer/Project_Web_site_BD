            ...
            <div class="tm-gallery" id="tmGallery">
              ...
              <div class="tm-gallery-item category-1">
                ...
                <figure class="effect-bubba">
                  <img
                    src="img/gallery/imprimer.jpg"
                    alt="Gallery item"
                    class="img-fluid"
                  />
                  <figcaption>
                    <h2><span>Impression</span></h2>
                    <p>Imprimer vous Documents.</p>
                    <a href="imprimer.php">View more</a>
                  </figcaption>
                </figure>
              </div>
              <div class="tm-gallery-item category-2">
                <figure class="effect-bubba">
                  <img
                    src="img/gallery/livre.jpg"
                    alt="Gallery item"
                    class="img-fluid"
                  />
                  <figcaption>
                    <h2><span>Emprunter</span></h2>
                    <p>emprunter des livres.</p>
                    <a href="emprunter.php">View more</a>
                  </figcaption>
                </figure>
              </div>
              <div class="tm-gallery-item category-1">
                <figure class="effect-bubba">
                  <img
                    src="img/gallery/table.jpg"
                    alt="Gallery item"
                    class="img-fluid"
                  />
                  <figcaption>
                    <h2><span>Table</span></h2>
                    <p>Réserver une place dans la bibliothèque.</p>
                    <a href="tables.php">View more</a>
                  </figcaption>
                </figure>
              </div>
