              ...
              <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ml-auto mr-0">
                  ...
                  <?php if  ($_SESSION['nom'] == 'z'){
                    ...
                    <div class="tm-nav-link-highlight"></div>
                    <a class="nav-link" href="inscrire.php">S_inscrire
        ...
        <div class="col-12 tm-page-cols-container">
          <div class="tm-page-col-left tm-welcome-box tm-bg-gradient">
            <p class="tm-welcome-text">
              <em
                >"Créer un Compte est soyer le Bienvenue ."</em
              >
            </p>
          </div>
          <div class="tm-page-col-right">
            <div
              ...
              data-image-src="img/inscrire.jpg"
            ></div>
          </div>
        </div>
      </div>
      ...
      <section class="row tm-pt-4 tm-mb-3">
        <div class="col-12 tm-page-cols-container">
          ...
          <div class="tm-page-col-right tm-form-container">
            <h2 class="tm-text-secondary mb-4">S'inscrire</h2>
            <form
              action="extd_profil.php"
              method="POST"
              id="tm_contact_form"
              ...
              echo'<div class="form-group">
               ...
               echo'<div class="form-group-2">
                <input
                  ...
                  class="form-control rounded-0 border-top-0 border-right-0 border-left-0"
                  value="'.$donnees['contact_etudiant'].'"
                  />
              </div>';
             ...
             echo'<div class="form-group">
               ...
               echo'<div class="form-group-2 input-field">
                <select class="tm-select" placeholder="'.$donnees['institut'].'" name="institut" id="occupation">
                  <option value="select">Selectionner votre institut</option>
                  <option value="Polytech_Nantes">Polytech_Nantes</option>
                  <option value="Lycee_Chaptal">Lycee_Chaptal</option>
                  <option value="Polytechnique_X">Polytechnique_X</option>
               ...
               echo'<div class="form-group-2">
                <input
                  ...
                  class="form-control rounded-0 border-top-0 border-right-0 border-left-0"
                  value="Question de sécurité :'.$donnees['reponse_question'].'"
                   />
              </div>';
               echo'<div class="">
                <button
