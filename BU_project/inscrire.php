      ...
      <section class="row tm-pt-4 tm-mb-3">
        <div class="col-12 tm-page-cols-container">
          ...
          <div class="tm-page-col-right tm-form-container">
            ...
            <form
              action="extd_entrep_etudiant2.php"
              method="POST"
              id="tm_contact_form"
              ...
              <div class="form-group-2">
                <input
                  type="email"
                  id="confemail"
                  name="confirme_contact_etudiant"
                  class="form-control rounded-0 border-top-0 border-right-0 border-left-0"
            ...
            <div class="form-group">
              ...
              <div class="form-group-2 input-field">
                <select class="tm-select" name="institut" id="occupation">
              ...
              <div class="form-group-2">
                <input
                  ...
                  class="form-control rounded-0 border-top-0 border-right-0 border-left-0"
                  placeholder="Question de sécurité : votre couleur préférer?"
                  required="required" />
              </div>
              <div class="">
                <button
