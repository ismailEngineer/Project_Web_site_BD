...
<html lang="en">
  <head>
    ...
    <title>Reserver une place</title>
<!--
            ...
            <nav class="navbar navbar-expand-lg navbar-light tm-navbar">
              ...
              <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ml-auto mr-0">
                  ...
                  <li class="nav-item">
                    <div class="tm-nav-link-highlight"></div>
                    <a class="nav-link" href="bu.html"> BU</a>
                  </li>
                  <li class="nav-item">
                    <div class="tm-nav-link-highlight"></div>
      ...
      <div class="row tm-welcome-row">
        <div class="col-12">
          <div
            ...
            data-image-src="img/table.jpg"
          >
            <div class="tm-bg-black-transparent tm-parallax-overlay">
              <h2>Reserver Maintenant</h2>
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="col-12 tm-page-cols-container">
          ...
          <div class="text-content">
                  <h3 class="tm-text-secondary tm-mb-5">
                    Liste des salle que vous pourriez les réserver :
                  </h3>
                  <p class="tm-mb-5">
                    ...
                    <table>
                      <thead>
                          <tr>
                              <th colspan="2">Les salles</th>
                          </tr>
                      </thead>
                      <tbody>
                          <tr>
                              <td>Numèro de Salle</td>
                              <td>Bibliothèque</td>
                    ...
                    $reponse = $bdd->query("SELECT * FROM `salle_de_travail` WHERE `disponibilite` = '1'");
                    while($donnees = $reponse->fetch())
                    {  
                        $id_bu = $donnees['bu'];
                        $reponse_bu = $bdd->query("SELECT * FROM `bibliotheque` WHERE `id_bu` ='$id_bu'");
                        $donnees_bu = $reponse_bu->fetch();
                        echo'<tr>';
                             echo '<td>'.$donnees['id_salle'].'</td>';
                             echo '<td>'.$donnees_bu['nom_bu'].'</td>';
                             echo '<td>'.$donnees['nombre_de_place'] .'</td>';
                             echo '<form name="FormAjout" action="extd_table.php" method="post">';
                             echo '<td>
                                  <label class="tm-w-50">
                                    <input
                                      type="checkbox"
