        ...
        <div class="header">
         ...
         <div class="content">
            ...
            <div class="content_ctn">
                ...
                <form name="FormAjout" action="extd_ajout_bibliotheque.php" method="post">
                    <table border=0>
                      <tr>
                          <td> Nom Bibliothèque</td>
                          <td> <input type="Nom" name ="nom_bu" maxlength="30" size="20"/></td>
                      </tr>
                      <tr>
                          <td> ville </td>
                          <td> <input type="text" name ="ville" maxlength="30" size="20"> </td>
                      </tr>
                      <tr>
                          <td> contact_bibliothèque </td>
                          <td> <input type="text" name ="contact_BU" maxlength=20 size=20><br> </td>
                      </tr>
                      <tr>
                          <td colspan=2> 
